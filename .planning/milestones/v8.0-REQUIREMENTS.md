# Requirements Archive: v8.0 Catalogue Produits
...
- [x] **MODAL-01**: Le CTA "Configurer ce modele" ouvre un modal large (90vw desktop, plein ecran mobile)
- [x] **MODAL-02**: Le modal est accessible (focus trap, fermeture Escape, aria-modal)
- [x] **MODAL-03**: Le modal affiche un placeholder "Configurateur a venir" avec le nom du canape selectionne
